...
//        }
    ...
    private void setupViewPager(){
        mHomeTl = findView(R.id.tl_home);
        mHomeVp = findView(R.id.vp_home);
        List<Fragment> fragments = new ArrayList<>();
        fragments.add(new HotWallpaperFragment());
        fragments.add(new ClassifyFragment());
        BasePagerAdapter basePagerAdapter = new BasePagerAdapter(getChildFragmentManager(),fragments,new String[]{"热门","分类","精选"});
        mHomeVp.setAdapter(basePagerAdapter);
        mHomeTl.setupWithViewPager(mHomeVp);
    }
    public <T> T findView(int resid){
        return (T)mContainer.findViewById(resid);
    }
}
